...
- groq-snapshot — Llama 3.1 8B, gratuit (snapshots session)
- groq-standard — Llama 3.3 70B, gratuit (sessions courantes)
- groq-qwen — Qwen 32B, gratuit (raisonnement)
- gemini-flash — Gemini 2.0 Flash, gratuit (quota épuisé — activer facturation)
- gemini-pro — Gemini 2.5 Pro, payant (quota épuisé — activer facturation)
- mistral-small — Mistral Small, gratuit

### Règle de routage
- Sessions normales → pool gratuit (groq-standard ou gpt-4o-mini)
- Snapshots → groq-snapshot (Llama 8B, ultra rapide)
- Tâches complexes (examens, évaluations) → modèle payant
