...
| 14 | Backup zero restore testing formel + RTO non mesuré | `/opt/academia/docs/04-infra/backup.md` | Quarterly DR drill : pick Niveau aléatoire, restore staging, validate smoke-test, doc temps. Écris `docs/99-runbooks/DISASTER_RECOVERY.md`. |
